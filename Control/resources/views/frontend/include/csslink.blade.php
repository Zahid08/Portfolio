...
<link rel="stylesheet" href="{{asset('frontend')}}/css/style.css" 				 type="text/css" media="all">
	<link rel="stylesheet" href="{{asset('frontend')}}/css/camera.css" id="camera-css" type="text/css" media="all">
	<link rel="stylesheet" href="{{asset('frontend')}}/css/swipebox.css"				 type="text/css" media="all">
